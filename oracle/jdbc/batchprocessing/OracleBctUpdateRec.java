...
public class OracleBctUpdateRec {
	public static void main(String args[] ) {
		   String host = "jdbc:oracle:thin:@db.freesql.com:1521/23ai_34ui2";
	        ...
	        try {
	        	...
	        	stmt.addBatch("update EMP set esal=esal+500 where egrade='a'");
	        	...
	        	stmt.executeBatch();
	        	 ...
	        	 PreparedStatement pst=con.prepareStatement("update EMP set esal=esal+500 where eno=?");
